const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "assets/layout-segment-context-CFih9vdY.js",
      "assets/navigation-DQN6zu37.js",
      "assets/url-utils-BW4074SE.js",
      "assets/link-CSfK1pvx.js",
...
var kr = `modulepreload`,
  ...
  Mr = {
    ...
    "4441f662a01b": async () => {
      let e = await Y(
        () => import(`./layout-segment-context-CFih9vdY.js`),
    ...
    c2747888630f: async () => {
      let e = await Y(() => import(`./link-CSfK1pvx.js`), __vite__mapDeps([7, 1, 2, 5, 6, 8]));
      return {
        get default() {
          return e.default;
        },
