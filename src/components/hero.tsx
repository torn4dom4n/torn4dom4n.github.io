...
export default function Hero() {
  ...
  return (
    <div className="pt-16 sm:pt-24 lg:pt-32">
      <GridContainer className="before:hidden">
        <div className="flex flex-col items-center px-4 text-center md:px-6 lg:px-8">
          <a
            ...
            className="mb-8 inline-flex items-center rounded-full border border-gray-950/5 bg-gray-100/50 px-3 py-1 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-100 dark:border-white/10 dark:bg-gray-900/50 dark:text-gray-400 dark:hover:bg-gray-900"
          >
          ...
          <div className="mt-12 w-full max-w-md">
            <div className="relative flex items-center rounded-lg border border-gray-950/5 bg-gray-100/50 p-1 font-mono text-sm dark:border-white/10 dark:bg-gray-900/50">
              ...
              <button
                ...
                className="inline-flex size-9 items-center justify-center rounded-md text-gray-500 transition-colors hover:bg-gray-200/50 hover:text-gray-950 dark:text-gray-400 dark:hover:bg-gray-800/50 dark:hover:text-white"
      ...
      <div aria-hidden="true" className="mt-24 h-px w-full bg-gray-950/5 dark:bg-white/10" />
    </div>
  );
}
