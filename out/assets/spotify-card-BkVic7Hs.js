...
var r = e(t()),
  i = n(),
  a = (0, r.forwardRef)(({ title: e, titleId: t, ...n }, r) =>
    (0, i.jsxs)(`svg`, {
      viewBox: `0 0 24 24`,
      width: `1.2em`,
      height: `1.2em`,
      ...
      ...n,
      children: [
        e ? (0, i.jsx)(`title`, { id: t, children: e }) : null,
        (0, i.jsx)(`path`, {
          fill: `currentColor`,
...
var c = (e, t) => {
  ...
  u = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  d = `-`,
  f = [],
  p = `arbitrary..`,
  m = (e) => {
  ...
  w = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
  te = (e) => {
  ...
  O = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(T)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(T) && ((c = s.slice(1)), (l = !0));
  ...
  le = (e) => e.endsWith(`%`) && H(e.slice(0, -1)),
  W = (e) => se.test(e),
  ue = () => !0,
  G = (e) => R.test(e) && !ce.test(e),
  K = () => !1,
  de = (e) => z.test(e),
  fe = (e) => B.test(e),
  pe = (e) => !q(e) && !Y(e),
  ...
  ke = (e) => e === `image` || e === `url`,
  Ae = (e) => e === `length` || e === `size` || e === `bg-size`,
  je = (e) => e === `length`,
  Me = (e) => e === `number`,
  Ne = (e) => e === `family-name`,
  Pe = (e) => e === `number` || e === `weight`,
  Fe = (e) => e === `shadow`,
  Ie = oe(() => {
    let e = P(`color`),
      t = P(`font`),
      ...
      C = () => [Y, q, c],
      w = () => [V, `full`, `auto`, ...C()],
      te = () => [U, `none`, `subgrid`, Y, q],
      T = () => [`auto`, { span: [`full`, U, Y, q] }, U, Y, q],
      E = () => [U, `auto`, Y, q],
      ne = () => [`auto`, `min`, `max`, `fr`, Y, q],
      D = () => [
        `start`,
        `end`,
        `center`,
      ...
      j = () => [V, `screen`, `full`, `dvw`, `lvw`, `svw`, `min`, `max`, `fit`, ...C()],
      re = () => [V, `screen`, `full`, `lh`, `dvh`, `lvh`, `svh`, `min`, `max`, `fit`, ...C()],
      M = () => [e, Y, q],
      ie = () => [...b(), Ce, ye, { position: [Y, q] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, we, he, { size: [Y, q] }],
      N = () => [le, X, J],
      F = () => [``, `none`, `full`, l, Y, q],
      I = () => [``, H, X, J],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, V, q, Y, g] }],
        container: [`container`],
        "container-type": [{ "@container": [``, `normal`, `size`, Y, q] }],
        "container-named": [me],
        columns: [{ columns: [H, q, Y, s] }],
        ...
        z: [{ z: [U, `auto`, Y, q] }],
        basis: [{ basis: [V, `full`, `auto`, s, ...C()] }],
        "flex-direction": [{ flex: [`row`, `row-reverse`, `col`, `col-reverse`] }],
        "flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [H, V, `auto`, `initial`, `none`, q] }],
        grow: [{ grow: [``, H, Y, q] }],
        shrink: [{ shrink: [``, H, Y, q] }],
        order: [{ order: [U, `first`, `last`, `none`, Y, q] }],
        ...
        "line-clamp": [{ "line-clamp": [H, `none`, Y, ge] }],
        leading: [{ leading: [a, ...C()] }],
        ...
        "text-decoration-thickness": [{ decoration: [H, `from-font`, `auto`, Y, J] }],
        "text-decoration-color": [{ decoration: M() }],
        "underline-offset": [{ "underline-offset": [H, `auto`, Y, q] }],
        ...
        "bg-image": [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, U, Y, q],
                radial: [``, Y, q],
                conic: [U, Y, q],
              },
              Te,
        ...
        "outline-offset": [{ "outline-offset": [H, Y, q] }],
        "outline-w": [{ outline: [``, H, X, J] }],
        "outline-color": [{ outline: M() }],
        shadow: [{ shadow: [``, `none`, u, Ee, xe] }],
        "shadow-color": [{ shadow: M() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Ee, xe] }],
        "inset-shadow-color": [{ "inset-shadow": M() }],
        "ring-w": [{ ring: I() }],
        "ring-w-inset": [`ring-inset`],
        "ring-color": [{ ring: M() }],
        "ring-offset-w": [{ "ring-offset": [H, J] }],
        "ring-offset-color": [{ "ring-offset": M() }],
        "inset-ring-w": [{ "inset-ring": I() }],
        "inset-ring-color": [{ "inset-ring": M() }],
        "text-shadow": [{ "text-shadow": [`none`, f, Ee, xe] }],
        "text-shadow-color": [{ "text-shadow": M() }],
        opacity: [{ opacity: [H, Y, q] }],
        ...
        blur: [{ blur: ce() }],
        brightness: [{ brightness: [H, Y, q] }],
        contrast: [{ contrast: [H, Y, q] }],
        "drop-shadow": [{ "drop-shadow": [``, `none`, p, Ee, xe] }],
        "drop-shadow-color": [{ "drop-shadow": M() }],
        grayscale: [{ grayscale: [``, H, Y, q] }],
        "hue-rotate": [{ "hue-rotate": [H, Y, q] }],
        invert: [{ invert: [``, H, Y, q] }],
        saturate: [{ saturate: [H, Y, q] }],
        sepia: [{ sepia: [``, H, Y, q] }],
        "backdrop-filter": [{ "backdrop-filter": [``, `none`, Y, q] }],
        "backdrop-blur": [{ "backdrop-blur": ce() }],
        "backdrop-brightness": [{ "backdrop-brightness": [H, Y, q] }],
        "backdrop-contrast": [{ "backdrop-contrast": [H, Y, q] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": [``, H, Y, q] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [H, Y, q] }],
        "backdrop-invert": [{ "backdrop-invert": [``, H, Y, q] }],
        "backdrop-opacity": [{ "backdrop-opacity": [H, Y, q] }],
        "backdrop-saturate": [{ "backdrop-saturate": [H, Y, q] }],
        "backdrop-sepia": [{ "backdrop-sepia": [``, H, Y, q] }],
        ...
        duration: [{ duration: [H, `initial`, Y, q] }],
...
function Le({ data: e, className: t }) {
  let [n, o] = (0, r.useState)(!1),
    s = (0, r.useRef)(null),
    c = (0, r.useId)().replace(/:/g, ``);
  return (
    (0, r.useEffect)(
      () => () => {
    ...
    (0, i.jsxs)(`div`, {
      ...
      children: [
        (0, i.jsx)(`div`, {
          className: `pointer-events-none absolute top-1/2 left-1/2 z-0 block aspect-square w-[120%] -translate-x-1/2 -translate-y-1/2`,
          children: (0, i.jsxs)(`div`, {
            className: `pointer-events-none flex h-full opacity-100 select-none`,
            children: [
              (0, i.jsx)(`img`, {
                src: e.image,
                alt: ``,
              ...
              (0, i.jsx)(`div`, {
                className: `absolute top-0 left-0 h-full w-full bg-[linear-gradient(180deg,rgba(0,0,0,0)_0,rgba(0,0,0,.8))]`,
              }),
            ],
          }),
        }),
        (0, i.jsxs)(`button`, {
          onClick: e.audio
            ? () => {
                e.audio &&
                  (s.current ||
                    ((s.current = new Audio(e.audio)),
                    (s.current.volume = 0.3),
                    s.current.addEventListener(`ended`, () => o(!1))),
                  n ? (s.current.pause(), o(!1)) : (s.current.play(), o(!0)));
              }
            : void 0,
          "aria-label": n ? `Pause preview` : `Play preview`,
          className: $(
            `group relative z-1 w-full max-w-18.75 self-center`,
            e.audio && `cursor-pointer`,
          ),
          children: [
            (0, i.jsx)(`img`, {
              src: e.image,
              ...
              className: $(
                ...
                e.audio && `group-hover:-translate-x-0.5`,
                n && `-translate-x-0.5`,
              ),
            }),
            e.audio &&
              (0, i.jsx)(`div`, {
                className: $(
                  ...
                  n ? `translate-x-[-10%]` : `translate-x-[-50%] group-hover:translate-x-[-10%]`,
                ),
                children: (0, i.jsxs)(`svg`, {
                  xmlns: `http://www.w3.org/2000/svg`,
                  viewBox: `0 0 110 110`,
                  className: `size-full animate-spin`,
                  style: { animationDuration: `1s`, animationPlayState: n ? `running` : `paused` },
                  children: [
                    (0, i.jsx)(`circle`, { cx: `55`, cy: `55`, r: `55`, fill: `#FFFFF` }),
                    (0, i.jsx)(`mask`, {
                      id: `mask0_${c}`,
                      width: `110`,
                      height: `110`,
                    ...
                    (0, i.jsxs)(`g`, {
                      ...
                      children: [
                        ...
                        (0, i.jsxs)(`g`, {
                          filter: `url(#filter-blur-8_${c})`,
                          opacity: `0.4`,
                          children: [
                            (0, i.jsx)(`path`, { fill: `#fff`, d: `M-14 38l68 19.579L-14 74V38z` }),
                            (0, i.jsx)(`path`, { fill: `#fff`, d: `M123 38L55 57.579 123 74V38z` }),
                            (0, i.jsx)(`path`, {
                              fill: `#fff`,
        ...
        (0, i.jsxs)(`div`, {
          className: `z-10 flex w-full flex-col justify-between`,
          children: [
            (0, i.jsx)(`div`, {
            ...
            (0, i.jsxs)(`div`, {
              className: `pl-6 text-end`,
              children: [
                (0, i.jsx)(`h3`, {
                  className: `text-sm font-semibold tracking-[-.006em] whitespace-nowrap text-foreground`,
                  children: e.title,
                }),
                (0, i.jsx)(`p`, {
                  className: `text-sm font-medium tracking-[-.006em] whitespace-nowrap text-muted-foreground`,
                  children: e.artist,
                }),
              ],
            }),
